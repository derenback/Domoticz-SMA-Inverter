...
if client.is_open:
    ...
    get_modbus_value(30773, "Side A DC Power", "W")
    get_modbus_value(30769, "Side A DC Current", "A")
    get_modbus_value(30771, "Side A DC Voltage", "V", 100)
    get_modbus_value(30961, "Side B DC Power", "W")
    get_modbus_value(30957, "Side B DC Current", "A")
    get_modbus_value(30959, "Side B DC Voltage", "V", 100)
